...
class GetFollowedPlaylists implements UseCase<List<PlaylistEntity>, NoParams> {
  final AudioRepository audioRepository;
  GetFollowedPlaylists(this.audioRepository);

  @override
  Future<Either<Failure, List<PlaylistEntity>>> call(NoParams params) async {
    return await audioRepository.getFollowedPlaylists();
  }
}
